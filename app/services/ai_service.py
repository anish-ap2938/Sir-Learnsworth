...
#     SYSTEM_PROMPT = f"""
#     You are Sir Learnsworth, an AI Tutor. Answer questions based on uploaded study materials.
...
#         else:
#             # The memory is automatically updated during chain invocation, so no need to manually save context here.

#             pass  # Remove or comment out any manual memory updates if present
